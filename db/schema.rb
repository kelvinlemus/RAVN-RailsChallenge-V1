...
ActiveRecord::Schema[7.2].define(version: 2024_09_16_130057) do
  ...
  create_table "pokemon_countries", force: :cascade do |t|
    ...
    t.index ["pokemon_id", "country_id"], name: "index_pokemon_countries_on_pokemon_id_and_country_id", unique: true
